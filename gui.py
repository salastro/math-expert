...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_7.setGeometry(QtCore.QRect(0, 0, 91, 91))
        self.label_7.setText("")
        self.label_7.setPixmap(QtGui.QPixmap("pyuic5/../logo.jpg"))
        ...
        self.gridLayout.addWidget(self.limBt, 14, 0, 1, 1)
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout.addWidget(self.pushButton, 16, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Solve ODE"))
